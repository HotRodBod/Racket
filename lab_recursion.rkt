...
#|-------------------------------------------------------------------------------
 | Name: Rodney Wotton
 | Pledge: I pledge my honor tha I have abided by the Stevens Honor System
 |-------------------------------------------------------------------------------|#


#|-------------------------------------------------------------------------------|
 |                     Lab 3: Recursion (20 PTS) (+2 EC PTS)                     |
 |-------------------------------------------------------------------------------|#
...
(define (subfact n)
  (cond
    ((= n 1) 0)
    ((= n 2) 1)
    ((and (> n 2) (even? n)) (+ (* n (subfact(- n 1))) 1))
    ((and (> n 2) (odd? n))  (- (* n (subfact(- n 1))) 1))))
...
(define (gen-fib a b n)
  (cond
    ((= n 0) a)
    ((= n 1) b)
    ((> n 1) (+ (gen-fib a b (- n 1)) (gen-fib a b (- n 2))))))
